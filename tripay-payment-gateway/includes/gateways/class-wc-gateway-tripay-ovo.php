...
class WC_Gateway_Tripay_OVO extends Tripay_Payment_Gateway
{
    public $sub_id = 'tripay_ovo';

    public function __construct()
    {
        parent::__construct();
        $this->method_title = 'TriPay - OVO';
        $this->method_description = 'Pembayaran melalui OVO';
        ...
        if ($this->settings['enable_icon'] == 'yes') {
            $this->icon = !empty($this->settings['custom_icon']) ? esc_url($this->settings['custom_icon']) : esc_url(plugins_url('/assets/ovo.png', dirname(__FILE__)));
        }
    }
    ...
    public function init_form_fields()
    {
        $this->form_fields = [
           'enabled' => [
               ...
               'label' => __('Aktifkan OVO', 'wc-tripay'),
               'type' => 'checkbox',
               'description' => '',
               'default' => 'no',
           ],
           'title' => [
               ...
               'default' => __('OVO', 'wc-tripay'),
           ],
           'enable_icon' => [
               'title' => __('Ikon Pembayaran', 'wc-tripay'),
               'label' => __('Aktifkan Ikon', 'wc-tripay'),
               'type' => 'checkbox',
               'description' => '<img src="'.esc_url(plugins_url('/assets/ovo.png', dirname(__FILE__))).'" style="height:100%;max-height:40px !important" />',
               'default' => 'no',
           ],
           'custom_icon' => [
           ...
           'description' => [
               ...
               'default' => 'Pembayaran melalui OVO',
           ],
           'expired' => [
