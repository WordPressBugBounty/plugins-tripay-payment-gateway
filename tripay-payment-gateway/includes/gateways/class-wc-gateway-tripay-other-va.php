...
class WC_Gateway_Tripay_OTHER_VA extends Tripay_Payment_Gateway
{
    public $sub_id = 'tripay_otherva';

    public function __construct()
    {
        parent::__construct();
        $this->method_title = 'TriPay - OTHER BANK VA';
        $this->method_description = 'Pembayaran melalui Other Bank Virtual Account';
        $this->payment_method = 'OTHERBANKVA';
    ...
    public function init_form_fields()
    {
        $this->form_fields = [
            'enabled' => [
                ...
                'label' => __('Aktifkan Other Bank Virtual Account', 'wc-tripay'),
                'type' => 'checkbox',
                'description' => '',
                'default' => 'no',
            ],
            'title' => [
                ...
                'default' => __('Other Bank Virtual Account', 'wc-tripay'),
            ],
            'enable_icon' => [
            ...
            'description' => [
                ...
                'default' => 'Pembayaran melalui Other Bank Virtual Account',
            ],
            'expired' => [
